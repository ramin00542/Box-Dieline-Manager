# Project Phases (MVP — 7 Phases, 30 Tasks)
...
## Phase 4: Template CRUD & File Upload (9 Tasks)
...
- task_04_08_template_edit.md
- task_04_09_template_soft_delete.md
...
**Total: 30 tasks across 7 phases (MVP).**
